                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-muted">Authored by: {{$book->author_name. " and ". $book->s_author_name}}</small></p>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Released On: {{$book->print_date}}</li>
                                <li class="list-group-item">Price: {{$book->book_price}} Ksh.</li>
                            </ul>
                            <div class="card-body">
                                <a href="#" class="card-link"><button class="btn btn-success">Get a Copy</button></a>
                            </div>
                        </div>
                    </div>
                </div>
